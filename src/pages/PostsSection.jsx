        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50/50 via-white to-rose-50/30 py-16 px-6">
            <div className="max-w-2xl mx-auto">
                <header className="flex flex-col items-center mb-16 relative">
                    ...
                    <h2 className="text-5xl md:text-6xl font-[1000] text-gray-900 tracking-tighter mb-6 text-center leading-[1.1]">
                        Student <span className="bg-gradient-to-r from-indigo-600 via-violet-600 to-rose-600 bg-clip-text text-transparent italic">Verse</span>
                    </h2>
