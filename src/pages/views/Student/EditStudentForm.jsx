    ...
    <div>
      <form onSubmit={edited(studentDetails?._id)}>
        <div className='border border-black flex flex-col m-5 p-5 space-y-5'>
           <h2>Name : <input type='text' name='Name' value={studentForm.Name}></input></h2>
           <h2>Age : <input type='number' name='Age' value={studentForm.Age}></input></h2>
           <h2>Gender : <select>
            <option value="">{studentForm.Gender}</option>
             <option value="Female"></option>
              <option value="Male"></option>
            </select></h2>
           <h2>Standard : <input type='number' name='Standard' value={studentForm.Standard}></input></h2>
           <h2>Division :<input type='text' name='Division' value={studentForm.Division}></input> </h2>
           <h2>Guardian Name : <input type='text' name='Guardian' value={studentForm.Guardian_Name}></input></h2>
