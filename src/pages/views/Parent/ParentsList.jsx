...
{/*         
      ...
      <div>
        <h3 className='font-bold p-3 text-amber-800 text-2xl'>Parents</h3>
          <table className='auto p-2 mx-[15%] shadow-md rounded-2xl mb-[50%]'>
            <thead className='bg-white text-amber-700 border rounded-2xl'>
              <tr className='p-5'>
